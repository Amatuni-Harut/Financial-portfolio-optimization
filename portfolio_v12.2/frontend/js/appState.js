 ...
 *
 * v9: добавлен applyLanguage() для i18n
 */
const AppState = {
    ...
    /**
     * Применить язык интерфейса — обновить все элементы с data-i18n.
     * Зависит от translations.js (должен быть загружен раньше).
     */
    applyLanguage(lang) {
        ...
        // Устанавливаем lang атрибут на <html>
        document.documentElement.setAttribute('lang', target === 'ru' ? 'ru' : 'en');
    }
};

// Применяем компактный режим и язык сразу при загрузке страницы
