"""
main.py — FastAPI приложение AssetAlpha.
"""
import logging
import os
...
async def optimize(request: OptimizeRequest):
    """
    Новичок:      1 модель (max_sharpe по умолчанию), базовые блоки.
    Профессионал: все модели параллельно, расширенные блоки +
                  ковариации / корреляции / сравнение всех портфелей.
    """
    ...
    # Обязательное quantity у каждого актива
    ...
    # Профессионал всегда получает все модели
