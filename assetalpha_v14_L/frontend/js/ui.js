    ...
    function initTheme() {
        ...
        function updateThemeIcon(theme) {
            ...
            btn.innerHTML = isDark
                // Луна — сейчас тёмная тема, нажатие переключит на светлую
                ? `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                       <path d="M21 12.79A9 9 0 1 1 11.21 3a7 7 0 0 0 9.79 9.79z"/>
                   </svg>`
                // Солнце — сейчас светлая тема, нажатие переключит на тёмную
                : `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        if (themeToggleBtn) {
            ...
            // Устанавливаем правильную иконку сразу при загрузке
            updateThemeIcon();
        }
