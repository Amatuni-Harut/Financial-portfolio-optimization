...
function portfolioMetricsTable(p) {
    ...
    const rows = [
        ...
        ['Прибыль/мес',     m.monthly_profit != null ? fmtMoney(m.monthly_profit) : '—'],
        ['Риск/мес',        m.monthly_risk   != null ? fmtMoney(m.monthly_risk)   : '—'],
...
function blockStockCharts(data) {
    ...
    return section('📈 Анализ акций', null, `
        ...
        <div class="chart-grid-3">
            ...
            <div class="chart-wrapper">
                <div class="chart-title">Прибыль/мес ($)</div>
...
function renderBeginnerResults(data, container) {
    ...
    if (data.input_portfolio && best) {
        ...
        <div class="chart-grid-3">
            ...
            <div class="chart-wrapper">
                <div class="chart-title">⏱ Окупаемость (мес)</div>
